...
public class RedisUtil {
    ...
    public static boolean pushList(String key, List<Object> value) {
    ...
    public static boolean getList(String key, List<Object> value, long time) {
