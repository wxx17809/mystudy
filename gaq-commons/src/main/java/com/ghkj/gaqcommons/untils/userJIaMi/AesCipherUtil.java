package com.ghkj.gaqcommons.untils.userJIaMi;


import com.ghkj.gaqcommons.untils.exception.CustomUnauthorizedException;
...
public class AesCipherUtil {
    ...
    public static void main(String[] args)throws UnsupportedEncodingException {
        System.out.println("wxx加密后的结果==="+enCrypto("wxx"));
    }
}
